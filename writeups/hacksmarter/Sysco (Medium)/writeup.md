...
![[writeups/hacksmarter/sysco (medium)/screenshots/logo.png]]
## Scenario
...
![[writeups/hacksmarter/sysco (medium)/screenshots/siteenum.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/kerbrute.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/asrepped.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/cracked.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/jackpwn3d.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/bloodhoundce.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/gobuster.png]]

On `/roundcube` `jack.dowland` has and account and from which, an email to `lainey.moore` was found with a router config file.
![[writeups/hacksmarter/sysco (medium)/screenshots/roundcube.png]]

![[writeups/hacksmarter/sysco (medium)/screenshots/sentemail.png]]

Opening up the router config file reveals an encrypted password. `$1$mERr$isugnYiHsjHT.i.tc2GDY.`
![[writeups/hacksmarter/sysco (medium)/screenshots/routerconfig.png]]

Utilizing [hashcat](https://hashcat.net/hashcat/) this hash was trivial to crack. Revealing the password of `Chocolate1`.
![[writeups/hacksmarter/sysco (medium)/screenshots/crackrouterhash.png]]
![[writeups/hacksmarter/sysco (medium)/screenshots/chocolate1.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/laineypwn3d.png]]

This user yields remote access and the first flag.
![[writeups/hacksmarter/sysco (medium)/screenshots/user.png]]

Browsing files reveals a .lnk with stored credentials `netadmin:5y5coSmarter2025!!!
![[writeups/hacksmarter/sysco (medium)/screenshots/puttycreds.png]]
![[writeups/hacksmarter/sysco (medium)/screenshots/puttycreds2.png]]

Spraying this password reveals it was reused with `Greg.Shields`. This is an escalation path to Domain Admin.
![[writeups/hacksmarter/sysco (medium)/screenshots/gregpwn3d.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/escpath.png]]

![[defaultdomainpolicypwn3d.png]]
![[writeups/hacksmarter/sysco (medium)/screenshots/defaultdomainsetowner.png]]
...
![[gpoabuse.png]]
![[writeups/hacksmarter/sysco (medium)/screenshots/pwn3dbox.png]]
...
![[writeups/hacksmarter/sysco (medium)/screenshots/dumpsam.png]]
![[writeups/hacksmarter/sysco (medium)/screenshots/done.png]]